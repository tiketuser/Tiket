    ...
    <div className="select-none h-[300px] sm:h-[400px] md:h-80 lg:h-72 relative bg-white mx-auto w-full shadow-xsmall-inner z-30 flex justify-center items-center overflow-x-hidden">
      <div className="flex flex-col justify-center text-center z-30 " dir="rtl">
        ...
        <p className="text-subtext leading-[27px] text-text-small font-light mb-5 sm:text-text-large sm:mb-8 ">
          נראה שהגעת לדף שלא קיים. יכול להיות שהכתובת שגויה או שהדף הועבר.
        </p>

        <div className="flex justify-center gap-4 sm:gap-8 md:gap-9 lg:gap-10">
          {/* כפתור חזרה לדף הבית */}
          <Link href="/">
            <button className="btn btn-primary text-heading-5-desktop h-[50px] sm:w-auto sm:h-16 text-gray-50 font-regular sm:text-heading-4-desktop scale-[0.87] sm:scale-90 md:scale-95 lg:scale-100">
              לדף הבית
            </button>
          </Link>
          ...
          <button
            ...
            className="btn btn-secondary border-primary border-[2px] bg-white text-primary text-heading-5-desktop h-[50px] sm:w-auto sm:h-16 font-regular sm:text-heading-4-desktop scale-[0.87] sm:scale-90 md:scale-95 lg:scale-100"
          >
            חזור אחורה
          </button>
        </div>

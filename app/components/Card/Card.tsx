...
const Card: React.FC<CardProps> = ({
  ...
  return (
    ...
    <div className="select-none transition-transform relative w-[392px] h-[600px] sm:w-[392px] sm:h-[568px] border-b-[4px] border-highlight p-[16px] pt-[16px] pr-[32px] pb-[32px] pl-[32px] shadow-xlarge hover:duration-500 hover:scale-110">
      {/* Last Chance */}
      {soldOut && (

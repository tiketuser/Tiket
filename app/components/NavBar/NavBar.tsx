...
const NavBar = () => {
    return (
        <div className="fixed navbar bg-white shadow-md flex justify-between items-center px-4 z-50">
            {/* Left Side */}
            <div>
            ...
            <div className="flex items-center space-x-6">
                <button role="btn" className="btn btn-ghost btn-circle avatar hover:bg-red-100" >
                    <Image
                        src={HeartIcon}
                        alt='heart icon'

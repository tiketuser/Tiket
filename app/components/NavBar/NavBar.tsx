  ...
  return (
    ...
    >
      ...
      <div className="flex space-x-6">
        ...
        <button className="btn btn-secondary border-primary border-[2px] bg-white w-24 text-primary text-text-large font-normal">
          הירשם
        </button>
        <button className="btn btn-primary w-24 text-gray-50 text-text-large font-normal">
          התחבר
        </button>

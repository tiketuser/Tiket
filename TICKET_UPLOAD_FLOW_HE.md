...
### תהליך 3: יצירה/קישור לקונצרט

המערכת מחפשת או יוצרת מסמך קונצרט באוסף `concerts`.
...
- ‍ מנהל יצור את הקונצרט ידנית מאוחר יותר
